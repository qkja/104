...
QT_MOC_LITERAL(3, 27, 6) // "result"
    ...
    "WorkerThread\0workFinished\0\0result"
};
...
void WorkerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WorkerThread::workFinished)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void WorkerThread::workFinished(const QString & _t1)
{
