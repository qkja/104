...
#include <memory>
#include "../../BoilerFeedPowderOnLineMonitoringSystem/mytime.h"
...
void MyTime::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MyTime *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->fromMyTimeToMianScreenSignals(); break;
        ...
        {
            using _t = void (MyTime::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTime::fromMyTimeToMianScreenSignals)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyTime::fromMyTimeToMianScreenSignals()
{
