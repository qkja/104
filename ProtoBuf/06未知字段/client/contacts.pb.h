...
class PeopleInfo final :
 ...
 public:
  ...
  private:
  bool _internal_has_weixin() const;
  public:
  void clear_weixin();
  ...
  private:
  const std::string& _internal_weixin() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_weixin(const std::string& value);
  std::string* _internal_mutable_weixin();
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    union OtherContactUnion {
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr weixin_;
    } other_contact_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
...
// string weixin = 6;
inline bool PeopleInfo::_internal_has_weixin() const {
  return other_contact_case() == kWeixin;
}
inline bool PeopleInfo::has_weixin() const {
  return _internal_has_weixin();
}
inline void PeopleInfo::set_has_weixin() {
  _impl_._oneof_case_[0] = kWeixin;
}
inline void PeopleInfo::clear_weixin() {
  if (_internal_has_weixin()) {
    _impl_.other_contact_.weixin_.Destroy();
    clear_has_other_contact();
  }
}
inline const std::string& PeopleInfo::weixin() const {
  // @@protoc_insertion_point(field_get:contacts.PeopleInfo.weixin)
  return _internal_weixin();
}
template <typename ArgT0, typename... ArgT>
inline void PeopleInfo::set_weixin(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_weixin()) {
    clear_other_contact();
    set_has_weixin();
    _impl_.other_contact_.weixin_.InitDefault();
  }
  _impl_.other_contact_.weixin_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:contacts.PeopleInfo.weixin)
}
inline std::string* PeopleInfo::mutable_weixin() {
  std::string* _s = _internal_mutable_weixin();
  // @@protoc_insertion_point(field_mutable:contacts.PeopleInfo.weixin)
  return _s;
}
inline const std::string& PeopleInfo::_internal_weixin() const {
  if (_internal_has_weixin()) {
    return _impl_.other_contact_.weixin_.Get();
  }
  return ::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited();
}
inline void PeopleInfo::_internal_set_weixin(const std::string& value) {
  if (!_internal_has_weixin()) {
    clear_other_contact();
    set_has_weixin();
    _impl_.other_contact_.weixin_.InitDefault();
  }
  _impl_.other_contact_.weixin_.Set(value, GetArenaForAllocation());
}
inline std::string* PeopleInfo::_internal_mutable_weixin() {
  if (!_internal_has_weixin()) {
    clear_other_contact();
    set_has_weixin();
    _impl_.other_contact_.weixin_.InitDefault();
  }
  return _impl_.other_contact_.weixin_.Mutable(      GetArenaForAllocation());
}
inline std::string* PeopleInfo::release_weixin() {
  // @@protoc_insertion_point(field_release:contacts.PeopleInfo.weixin)
  if (_internal_has_weixin()) {
    clear_has_other_contact();
    return _impl_.other_contact_.weixin_.Release();
  } else {
    return nullptr;
  }
}
inline void PeopleInfo::set_allocated_weixin(std::string* weixin) {
  if (has_other_contact()) {
    clear_other_contact();
  }
  if (weixin != nullptr) {
    set_has_weixin();
    _impl_.other_contact_.weixin_.InitAllocated(weixin, GetArenaForAllocation());
  }
  // @@protoc_insertion_point(field_set_allocated:contacts.PeopleInfo.weixin)
}
