...
QT_MOC_LITERAL(5, 58, 4) // "init"

    },
    "Alarm\0back\0\0on_pushButton_clicked\0"
    "on_pushButton_2_clicked\0init"
};
...
void Alarm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Alarm::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Alarm::back)) {
                *result = 0;
                return;
            }
        }
