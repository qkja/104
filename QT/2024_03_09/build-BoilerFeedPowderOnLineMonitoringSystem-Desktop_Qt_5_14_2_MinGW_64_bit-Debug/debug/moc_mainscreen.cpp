...
#include <memory>
#include "../../BoilerFeedPowderOnLineMonitoringSystem/mainscreen.h"
...
QT_MOC_LITERAL(1, 11, 11), // "quitSignals"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "MainScreen\0quitSignals\0"
};
...
void MainScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainScreen::quitSignals)) {
                *result = 0;
                return;
            }
        }
