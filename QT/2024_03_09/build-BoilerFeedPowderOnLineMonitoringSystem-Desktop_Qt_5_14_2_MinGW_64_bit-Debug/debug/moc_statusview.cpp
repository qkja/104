/****************************************************************************
** Meta object code from reading C++ file 'statusview.h'
**
...
#include <memory>
#include "../../BoilerFeedPowderOnLineMonitoringSystem/statusview.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'statusview.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_StatusView_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject StatusView::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_StatusView.data,
    qt_meta_data_StatusView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *StatusView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_StatusView.stringdata0))
